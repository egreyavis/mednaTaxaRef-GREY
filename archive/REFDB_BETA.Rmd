...
subset_for_testing <- "no" # put yes if you want to do this, anything else will be no. If yes, fill out the variables below.
min_length <- 100 # reference sequences below this length in bp will be removed, any non-numeric value like "skip" will skip this step
max_length <- 4000 #reference sequences above this length in bp will be removed, any non-numeric value like "skip" will skip this step  
