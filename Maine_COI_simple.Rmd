...
# Save results
fwrite(tax_df, file.path(output_folder, "tax_accessions.csv"))
...
REFDB_accessions <- rbindlist(lapply(1:nrow(tax_df), function(i) {
  cat("\rFetching accessions for species", i, "of", nrow(tax_df))
  
  result <- fetch_species_accessions(
...
cat("\nComplete! Scraped", nrow(REFDB_accessions), "sequences\n")
...
fwrite(REFDB_unique, file.path(output_folder, "REFDB_unique.csv")) # Save results
...
# Save results
fwrite(species_summary, file.path(output_folder, "species_list_summary.csv"))
...
write.table(REFDB_unique_dada, file.path(output_folder, "REFDB_unique_dada.fasta"), sep="\n", col.names=FALSE, row.names=FALSE, quote=FALSE)
